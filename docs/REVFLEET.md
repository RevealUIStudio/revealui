...
| 5 | **Enterprise** | License plus studio support on admin.revealui.com (Contact sales / inquire — not a public monthly SKU). The customer self-hosts. Not a Studio-operated customer VM. | Customers on the Enterprise license tier |
...
Status: pre-launch (0 paying customers). Enterprise is a license plus studio support (Contact sales / inquire — not a public monthly SKU); you self-host. RevealUI Fleet is the self-host how-to via RevForge, not a catalog SKU.
