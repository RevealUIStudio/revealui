...
status: verified
title: "RevealFleet"
description: "Family name for RevealUI Studio software. RevealUI is the lead product. Not a catalog SKU."
category: overview
audience: public
---
...
RevealFleet (`/docs/REVEALFLEET`) is the family name for RevealUI Studio software. It is **not** a buyable SKU and **not** a public get-started path.
...
- Marketing templates: [revealui.com/templates](https://revealui.com/templates) — Deploy to Vercel for the four Next.js GitHub twins. There is no live `vercel.com/templates` listing.

## Related

- [What is RevealUI?](./WHAT_IS.md)
- [RevealFleet](./FLEET.md)
