...
This document explains the path alias strategy used across the RevealUI monorepo for both TypeScript compilation (`tsconfig.json`) and test resolution (`vitest.config.ts`).
...
- `docs/development/TOOLING-VERSIONS.md` - Tool versions and compatibility
- `docs/architecture/MONOREPO-STRUCTURE.md` - Overall monorepo organization
- `packages/dev/src/ts/base.json` - Base TypeScript configuration
