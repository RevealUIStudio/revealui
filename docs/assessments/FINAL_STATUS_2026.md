...
- **Exports:** Added to `packages/revealui/package.json`
...
**Solution:**
- Added to `packages/revealui/package.json` exports:
  ```json
  "./utils/logger": {
...
### Created (9 files)
1. `packages/revealui/src/core/types/jobs.ts`
2. `packages/revealui/src/core/utils/logger.ts`
3. `packages/revealui/src/core/utils/errors.ts`
...
- `packages/revealui/package.json` (added exports)
