# CI/CD Environment Guide

This guide explains the CI/CD environment used by RevealUI and how it differs from local development environments.
...
3. [Local vs CI Comparison](#local-vs-ci-comparison)
4. [Why CI Doesn't Use Nix or Docker](#why-ci-doesnt-use-nix-or-docker)
5. [CI Workflow Stages](#ci-workflow-stages)
6. [Environment Variables](#environment-variables)
7. [Testing Against CI Locally](#testing-against-ci-locally)
8. [Common CI Issues](#common-ci-issues)
9. [Node.js Version Strategy](#nodejs-version-strategy)
10. [CI Best Practices](#ci-best-practices)
