...
description: "Every software company ships the same five things: people, content, offers, payments, and agents. RevealUI pre-wires them so you build the business, not the plumbing."
visibility: public
status: narrative
audience: user
