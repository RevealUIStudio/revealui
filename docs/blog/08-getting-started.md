...
RevealUI ships with 13 first-party MCP (Model Context Protocol) servers (including Stripe, Neon, Vercel, Playwright, Code Validator, and Next.js DevTools). See the full list in [`packages/mcp/src/servers/`](https://github.com/RevealUIStudio/revealui/tree/main/packages/mcp/src/servers). Let your AI agents interact directly with your business infrastructure.
