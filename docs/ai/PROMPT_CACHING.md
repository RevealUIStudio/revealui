...
description: "RevealUI's AI layer is provider-agnostic: open-weight models (Gemma, Phi, etc. via Ollama or Inference Snaps) are the default runtime path, and cloud providers are opt-in adapte..."
visibility: public
status: verified
audience: user
---
