...
|---------|----------|-------|
| **RevealUI** (monorepo) | Beta | Deployed, 27 npm packages, extensive test suite. No paying users yet. |
...
- **Database**  -  85 tables via Drizzle ORM. Neon (primary) + ElectricSQL (sync). Supabase retired per ADR `2026-05-01-supabase-removal.md`.
