...
| `REVEALUI_LICENSE_PRIVATE_KEY` | No | None | Ed25519 PEM private key for signing license keys. Generated by `pnpm stripe:keys`. | HIGH (server-only) | api |
| `REVEALUI_LICENSE_PUBLIC_KEY` | No | None | Ed25519 PEM public key for verifying license keys. | MEDIUM | admin, api |
