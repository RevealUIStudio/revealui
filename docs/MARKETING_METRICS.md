...
| DB tables (Drizzle pgTable) | **101** | `countDbTables()` — `pgTable(` declarations across `packages/db/src/schema/*.ts` | Was 86 (2026-06-22); 93 after GAP-300; 96 on 2026-07-22; 97 after GAP-355 S4-1 `audit_anchors` (2026-07-23); 98 after GAP-260 P4-5 `license_jti_revocations` (2026-07-31); 100 after GAP-464 `account_sso_providers` + `sso_identities` (2026-08-02); **101** after GAP-448 `kit_fulfillments` (2026-08-02). `site.ts` METRICS.dbTables is gate-enforced by claim-drift. |
