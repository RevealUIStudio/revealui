...
| PKG-003 | @revealui/db | Drizzle ORM schema (104 tables) on NeonDB (Postgres) | npm | Public |
| PKG-004 | @revealui/auth | Session auth, password reset, rate limiting | npm | Public |
| PKG-005 | @revealui/presentation | 66 native UI components (Tailwind v4) | npm | Public |
...
**NeonDB (DS-001):** Primary relational data across 104 tables.
