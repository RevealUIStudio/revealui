...
1. **NeonDB (POSTGRES_URL — primary)**: Transactional REST API source. Houses 84 tables including `agent_memories` and other vector-typed tables (NeonDB supports `pgvector`). Source of truth for the application.
