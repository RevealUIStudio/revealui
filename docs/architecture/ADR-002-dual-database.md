...
1. **NeonDB** (primary)  -  All transactional data: users, content, billing, sessions, auth, marketplace. Accessed via Drizzle ORM over HTTP (serverless-compatible). 97 tables. Schema managed by drizzle-kit migrations.
