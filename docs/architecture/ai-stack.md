---
title: "AI Stack Architecture"
description: "RevealUI's AI subsystem lives in `@revealui/ai` (Pro, Fair Source FSL-1.1-MIT). It provides open-model inference, agent orchestration, CRDT-based memory, RAG ingestion, and stre..."
visibility: public
status: verified
audience: user
---
...
|------|-----------|-----------|--------------|-----------|
| **Free** | Local only (Ollama / snaps) | Local AI | Read-only | `INFERENCE_SNAPS_BASE_URL` or `OLLAMA_BASE_URL` |
