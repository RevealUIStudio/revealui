...
"@revealui/types": ["../../packages/core/src/core/types/unified.ts"],  // ❌ FILE DOESN'T EXIST
...
```json
// Should be:
"@revealui/types": ["../../packages/core/src/core/types/index.ts"],
```
...
```json
// FROM:
"@revealui/types": ["../../packages/core/src/core/types/unified.ts"],
