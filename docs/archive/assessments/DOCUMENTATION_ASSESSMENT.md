...
- **Current State**: ✅ **VERIFIED** - neon.ts exists at `packages/core/src/core/generated/types/neon.ts`
...
3. **Verify Current State** ✅ **VERIFIED**
   ...
   - ✅ neon.ts exists in `packages/core/src/core/generated/types/neon.ts`
