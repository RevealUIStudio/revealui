...
```typescript
// reveal.config.ts
import { defineConfig } from 'revealui/config'
import react from 'revealui/plugins/react'
import revealui from 'revealui/plugins/revealui'
import vercel from 'revealui/plugins/vercel'
...
import reveal from 'revealui/plugin'
...
- Ensure TypeScript can resolve `revealui/config`
...
- Open a GitHub issue
- Review [Drizzle Guide](../DRIZZLE-GUIDE.md) for database configuration
