...
```typescript
// my-plugin.ts
import { definePlugin } from 'revealui/plugin'
...
```typescript
import type { RevealPlugin } from 'revealui/plugin'
...
- See [Known Limitations](../KNOWN-LIMITATIONS.md) for plugin development notes
