...
RevealUI ships 68 UI components. Use them to build a pricing page in your frontend app.
...
- **Customize the UI**  -  `packages/presentation` has 68 components to build with
