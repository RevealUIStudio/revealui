...
RevealUI ships 65 UI components. Use them to build a pricing page in your frontend app.
...
- **Customize the UI**  -  `packages/presentation` has 65 components to build with
