...
| C18 | `config.slug` used as SQL table name via string interpolation with no alphanumeric validation | `packages/core/src/collections/operations/find.ts:36` |
...
*Generated 2026-03-12 by exhaustive 8-agent parallel audit. Every source file in the monorepo was read.*
