...
// Posts /api/auth/signup (live is /api/auth/sign-up) and /signup-with-profile
// (no such route). Do not treat this as a live full-stack proof (F-062-0003).
test.describe
  .skip('Full-Stack User Flows', () => {
    let db: DbTestHelper;
