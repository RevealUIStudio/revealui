...
**Comparison:** See [docs/ENVIRONMENT-VARIABLES-GUIDE.md](../docs/ENVIRONMENT-VARIABLES-GUIDE.md) for environment configuration details.
...
| **Admin** | 4000 | Admin dashboard (after running `pnpm dev`) |
