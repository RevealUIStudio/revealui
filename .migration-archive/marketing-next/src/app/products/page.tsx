...
export const metadata: Metadata = {
  ...
  description:
    'Five primitives built for you and accessible to your agents. Users, content, products, payments, and intelligence, pre-wired and ready to deploy.',
  openGraph: {
    title: 'Products | RevealUI',
    description:
      'Five primitives built for you and accessible to your agents. Users, content, products, payments, and intelligence, pre-wired and ready to deploy.',
...
// ---------------------------------------------------------------------------
// Primitives data - two-layer messaging framework
// ---------------------------------------------------------------------------
