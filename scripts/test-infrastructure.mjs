...
console.log(
	`   File structure: ${fileChecksPassed}/${requiredFiles.length} files present`,
);
...
const requiredScripts = ["changeset", "changeset:version", "changeset:publish"];
...
try {
	...
	console.log(
		`   Scripts: ${scriptChecksPassed}/${requiredScripts.length} present`,
	);
} catch (error) {
...
console.log(
	`   Validation scripts: ${validationChecksPassed}/${validationScripts.length} present`,
);
...
const tests = [
	...
	{
		name: "Workflow Files",
		passed: workflowChecksPassed === expectedWorkflows.length,
	},
	{
		name: "Package Scripts",
		passed: scriptChecksPassed === requiredScripts.length,
	},
	{
		name: "Validation Scripts",
		passed: validationChecksPassed === validationScripts.length,
	},
];
