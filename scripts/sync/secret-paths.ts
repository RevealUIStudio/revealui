...
export const SECRET_PATHS: SecretPathDef[] = [
  ...
  },
  {
    ...
    note: 'Ed25519 SPKI PEM - published for offline receipt verification; derivable from the private key. See docs/security/AUDIT_RECEIPTS.md (Stage 4: row verify free; root download Pro)',
  },
