...
import { generateBrutalHonestyPromptPrefix } from '../cohesion/utils/brutal-honesty.js'
import { createLogger, getProjectRoot, writeFile } from '../shared/utils.js'
import type { RalphStartOptions } from './types.js'
import { getPromptFilePath, getStateFilePath, isWorkflowActive, writeStateFile } from './utils.js'
...
function parseArguments(): RalphStartOptions & { help: boolean } {
  ...
  return { prompt, maxIterations, completionPromise, brutalHonesty, help: false }
}
