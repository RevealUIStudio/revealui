...
$files = Get-ChildItem -Path "apps/cms/src", "apps/web/src", "packages/revealui/src" -Include "*.ts", "*.tsx", "*.js", "*.jsx" -Recurse -Exclude "node_modules", "__tests__", "dist", ".next" -ErrorAction SilentlyContinue
