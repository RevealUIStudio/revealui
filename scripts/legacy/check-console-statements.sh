...
done < <(find apps/cms/src apps/web/src packages/revealui/src -type f \( -name "*.ts" -o -name "*.tsx" -o -name "*.js" -o -name "*.jsx" \) ! -path "*/node_modules/*" ! -path "*/__tests__/*" ! -path "*/dist/*" ! -path "*/.next/*" 2>/dev/null)
