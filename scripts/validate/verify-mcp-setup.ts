...
const MCP_SERVERS: MCPServer[] = [
  {
    name: 'Neon Database',
    adapter: 'scripts/mcp/adapters/neon.ts',
  ...
  {
    name: 'Stripe',
    adapter: 'scripts/mcp/adapters/stripe.ts',
  ...
  {
    name: 'Vercel',
    adapter: 'scripts/mcp/adapters/vercel.ts',
    envVars: ['VERCEL_TOKEN'],
    command: 'pnpm mcp:vercel',
  },
  {
    name: 'Supabase',
    adapter: 'scripts/mcp/adapters/supabase.ts',
    envVars: ['SUPABASE_URL', 'SUPABASE_SERVICE_ROLE_KEY'],
    command: 'pnpm mcp:supabase',
  },
  {
    name: 'Playwright',
    adapter: 'scripts/mcp/adapters/playwright.ts',
    envVars: [],
    command: 'pnpm mcp:playwright',
  },
  {
    name: 'Next.js DevTools',
    adapter: 'scripts/mcp/adapters/next-devtools.ts',
    envVars: [],
