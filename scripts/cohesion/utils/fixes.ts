...
const typeAssertionFix: FixStrategy = {
	...
	canFix: (issue: CohesionIssue) => {
		return (
			issue.pattern === "type-assertion-any" ||
			issue.pattern === "type-assertion-unknown"
		);
	},
...
const importStandardizationFix: FixStrategy = {
	...
	description:
		"Convert unscoped imports (revealui/) to scoped imports (@revealui/)",
