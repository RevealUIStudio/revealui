...
import { createLogger, fileExists, getProjectRoot, readFile } from '../shared/utils.js'
import type { CohesionAnalysis } from './types.js'
import { enhanceWithBrutalHonesty, validateBrutalHonesty } from './utils/brutal-honesty.js'
import { generateAssessment } from './utils/templates.js'
