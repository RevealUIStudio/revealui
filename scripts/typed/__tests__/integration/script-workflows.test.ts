...
import {execCommand} from '../../../packages/core/src/scripts/utils.ts'
...
describe('Script Workflows - Integration Tests', () => {
  ...
  describe('Shared utilities integration', () => {
    it('should create logger with all methods', async () => {
      const { createLogger } = await import('../../../packages/core/src/scripts/utils.ts')
  ...
  describe('File operations', () => {
    it('should read files correctly', async () => {
      const { readFile } = await import('../../../packages/core/src/scripts/utils.ts')
      const { fileURLToPath } = await import('node:url')
