...
- **11 MCP servers:** agents discover and use your business data through the same API humans use
...
| **Intelligence** | AI agents, open-model inference, task history _(Pro)_            | A2A protocol, CRDT memory, 11 MCP servers.                   |
