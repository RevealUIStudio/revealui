...
import { EpisodicMemory } from '../../src/core/memory/episodic-memory'
import { CRDTPersistence } from '../../src/core/persistence/crdt-persistence'
import { NodeIdService } from '../../src/core/services/node-id-service'
      ...
      values: vi.fn((data: any) => {
        ...
        for (const item of dataArray) {
          if (
            ...
            memories[item.id] = { ...item, createdAt: new Date(), updatedAt: new Date() }
          }
        }
