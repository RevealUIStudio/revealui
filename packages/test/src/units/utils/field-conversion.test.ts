...
describe("Field Conversion Utilities", () => {
	...
	describe("convertFromRevealUIField", () => {
		...
		it("should preserve validate function", () => {
			...
			expect(convertedBack.validate?.("too long string", {} as any)).toBe(
				"Value too long",
			);
		});
	});
	...
	describe("validateRevealUIField", () => {
		it("should return true for valid value", () => {
			...
			const result = validateRevealUIField(
				revealUIField,
				"Test Title",
				context,
			);
		...
		it("should validate min length for string", () => {
			...
			const result2 = validateRevealUIField(
				revealUIField,
				"Test Title",
				context,
			);
		...
		it("should validate max length for string", () => {
			...
			const result1 = validateRevealUIField(
				revealUIField,
				"This is too long",
				context,
			);
