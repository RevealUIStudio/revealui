 ...
 * - Condition functions
 *
 * @module @revealui/schema/core/contracts/config
 */

import type { EndpointConfig } from './functions'
import type { CollectionStructure, FieldStructure, GlobalStructure } from './structure'
