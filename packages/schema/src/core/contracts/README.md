...
```typescript
import { createContract } from '@revealui/schema/core/contracts'
import { z } from 'zod'
...
```typescript
import { ConfigContract, validateConfigStructure } from '@revealui/schema/core/contracts'
...
**After:**
```typescript
import { validateConfigStructure, ConfigValidationError } from '@revealui/schema/core/contracts'
