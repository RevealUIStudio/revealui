/**
 * Mock Payload Types for Isolated Unit Testing
 * 
 ...
 * in isolation.
 * 
 * @module @revealui/schema/__tests__/mocks/payload
 */
...
export function createMockRequest(overrides: Partial<MockPayloadRequest> = {}): MockPayloadRequest {
  return {
    user: null,
    locale: 'en',
    fallbackLocale: 'en',
...
export function createAdminRequest(): MockPayloadRequest {
