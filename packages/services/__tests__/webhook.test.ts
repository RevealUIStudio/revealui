...
describe('Webhook Signature Validation', () => {
  ...
  it('should reject request with invalid signature', async () => {
    ...
    const spy = vi.spyOn(protectedStripe.webhooks, 'constructEvent').mockImplementation(() => {
  ...
  it('should accept request with valid signature', async () => {
    ...
    const spy = vi.spyOn(protectedStripe.webhooks, 'constructEvent').mockReturnValue(event)
