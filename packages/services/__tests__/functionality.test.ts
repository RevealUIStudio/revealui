        ...
        const mockReq = createMockRevealRequest({
          revealui: {
            findByID: vi.fn().mockResolvedValue({
              ...
              cart: {
                items: [
                  { product: { stripeProductID: 'prod_one_time' }, quantity: 2 }, // $20
                  { product: { stripeProductID: 'prod_recurring' }, quantity: 1 }, // Skipped (null)
                ],
              },
            }),
            update: vi.fn().mockResolvedValue({}),
        ...
        const mockReq = createMockRevealRequest({
          revealui: {
            findByID: vi.fn().mockResolvedValue({
              ...
              stripeCustomerID: 'cus_test',
              cart: {
                items: [{ product: { stripeProductID: 'prod_recurring' }, quantity: 1 }],
              },
            }),
            update: vi.fn().mockResolvedValue({}),
          } as unknown as RevealUIInstance,
