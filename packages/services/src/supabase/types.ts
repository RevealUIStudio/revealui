...
export type Database = {
  public: {
    Tables: {
      ...
      _pages_v_blocks_banner: {
        Row: {
          ...
          id: number;
          style:
            | Database["public"]["Enums"]["enum__pages_v_blocks_banner_style"]
            | null;
        };
        Insert: {
          _order: number;
      ...
      _pages_v_blocks_code: {
        Row: {
          ...
          id: number;
          language:
            | Database["public"]["Enums"]["enum__pages_v_blocks_code_language"]
            | null;
        };
        Insert: {
          _order: number;
      ...
      _pages_v_blocks_media_block: {
        Row: {
          ...
          position:
            | Database["public"]["Enums"]["enum__pages_v_blocks_media_block_position"]
            | null;
        };
        Insert: {
          _order: number;
      ...
      _prices_v: {
        Row: {
          ...
          parent_id: number | null;
          published_locale:
            | Database["public"]["Enums"]["enum__prices_v_published_locale"]
            | null;
          snapshot: boolean | null;
          updated_at: string;
          version__status:
            | Database["public"]["Enums"]["enum__prices_v_version_status"]
            | null;
          version_created_at: string | null;
      ...
      _products_v: {
        Row: {
          ...
          parent_id: number | null;
          published_locale:
            | Database["public"]["Enums"]["enum__products_v_published_locale"]
            | null;
          snapshot: boolean | null;
          updated_at: string;
          version__status:
            | Database["public"]["Enums"]["enum__products_v_version_status"]
            | null;
          version_created_at: string | null;
          version_enable_paywall: boolean | null;
          version_price_j_s_o_n: string | null;
      ...
      pages: {
        ...
        Insert: {
          ...
          hero_rich_text?: Json | null;
          hero_type?:
            | Database["public"]["Enums"]["enum_pages_hero_type"]
            | null;
          id?: number;
          meta_description?: string | null;
          meta_image_id?: number | null;
      ...
      pages_blocks_banner: {
        Row: {
          ...
          id: string;
          style:
            | Database["public"]["Enums"]["enum_pages_blocks_banner_style"]
            | null;
        };
        Insert: {
          _order: number;
      ...
      pages_blocks_code: {
        Row: {
          ...
          id: string;
          language:
            | Database["public"]["Enums"]["enum_pages_blocks_code_language"]
            | null;
        };
        Insert: {
          _order: number;
      ...
      pages_blocks_media_block: {
        Row: {
          ...
          media_id: number | null;
          position:
            | Database["public"]["Enums"]["enum_pages_blocks_media_block_position"]
            | null;
        };
        Insert: {
          _order: number;
      ...
      prices_blocks_archive: {
        Row: {
          ...
          limit: number | null;
          populate_by:
            | Database["public"]["Enums"]["enum_prices_blocks_archive_populate_by"]
            | null;
          relation_to:
            | Database["public"]["Enums"]["enum_prices_blocks_archive_relation_to"]
            | null;
        };
        Insert: {
          _order: number;
      ...
      prices_blocks_cta_links: {
        Row: {
          ...
          link_new_tab: boolean | null;
          link_type:
            | Database["public"]["Enums"]["enum_prices_blocks_cta_links_link_type"]
            | null;
          link_url: string | null;
        };
        Insert: {
      ...
      prices_blocks_media_block: {
        Row: {
          ...
          media_id: number | null;
          position:
            | Database["public"]["Enums"]["enum_prices_blocks_media_block_position"]
            | null;
        };
        Insert: {
          _order: number;
      ...
      products_blocks_cta_links: {
        Row: {
          ...
          link_new_tab: boolean | null;
          link_type:
            | Database["public"]["Enums"]["enum_products_blocks_cta_links_link_type"]
            | null;
          link_url: string | null;
        };
        Insert: {
      ...
      products_blocks_media_block: {
        Row: {
          ...
          media_id: number | null;
          position:
            | Database["public"]["Enums"]["enum_products_blocks_media_block_position"]
            | null;
        };
        Insert: {
          _order: number;
      ...
      redirects: {
        ...
        Insert: {
          ...
          id?: number;
          to_type?:
            | Database["public"]["Enums"]["enum_redirects_to_type"]
            | null;
          to_url?: string | null;
          updated_at?: string;
        };
      ...
      users_tenants_roles: {
        ...
        Insert: {
          ...
          parent_id: string;
          value?:
            | Database["public"]["Enums"]["enum_users_tenants_roles"]
            | null;
        };
        Update: {
          id?: number;
    ...
    Enums: {
      ...
      enum__prices_v_blocks_content_columns_link_appearance:
        | "default"
        | "primary"
        | "secondary";
      enum__prices_v_blocks_content_columns_link_type: "reference" | "custom";
      enum__prices_v_blocks_content_columns_size:
        | "oneThird"
        | "half"
        | "twoThirds"
        | "full";
      ...
      enum_contents_blocks_menu_menus_main_menu_sub_menu_link_type:
        | "reference"
        | "custom";
      enum_contents_blocks_menu_menus_main_menu_type:
        | "reference"
        | "custom"
        | "none";
      ...
      enum_layouts_blocks_menu_main_menu_sub_menu_link_appearance:
        ...
        | "secondary"
        | "default";
      enum_layouts_blocks_menu_menus_main_menu_sub_menu_link_type:
        | "reference"
        | "custom";
      enum_layouts_blocks_menu_menus_main_menu_type:
        | "reference"
        | "custom"
        | "none";
      ...
      enum_posts_blocks_content_columns_size:
        ...
        | "twoThirds"
        | "full";
      enum_posts_blocks_cta_links_link_appearance:
        | "primary"
        | "secondary"
        | "default"
        | "outline";
      ...
      enum_prices_blocks_content_columns_link_appearance:
        | "default"
        | "primary"
        | "secondary";
      enum_prices_blocks_content_columns_link_type: "reference" | "custom";
      enum_prices_blocks_content_columns_size:
        | "oneThird"
        | "half"
        | "twoThirds"
        | "full";
      enum_prices_blocks_cta_links_link_appearance:
        | "primary"
        | "secondary"
        | "default"
        | "outline";
      ...
      enum_slug_blocks_menu_main_menu_sub_menu_link_appearance:
        | "primary"
        | "secondary"
        | "default";
