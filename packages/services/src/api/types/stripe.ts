...
export type StripeWebhookEvent<T extends Stripe.Event.Type> = Stripe.Event & {
	type: T;
	data: {
		object: T extends keyof Stripe.Event.Data.Object
			? Stripe.Event.Data.Object[T]
			: unknown;
	};
};
 ...
 */
export type ExtendedStripeWebhookEvent<T extends string> = Omit<
	Stripe.Event,
	"type" | "data"
> & {
	type: T;
