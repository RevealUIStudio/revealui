...
export const AutoSaveFeature = (options?: { interval?: number }): RichTextFeature => ({
  name: 'auto-save',
  key: 'auto-save',
  type: 'utility',
  options: {
...
// Block features
export const BlocksFeature = (options?: { enabledBlocks?: string[] }): RichTextFeature => ({
  name: 'blocks',
  key: 'blocks',
  type: 'block',
  options: {
...
// Embed features
export const EmbedFeature = (options?: { enabledEmbeds?: string[] }): RichTextFeature => ({
  name: 'embed',
  key: 'embed',
  type: 'block',
  options: {
