...
This module defines the RevealUI type system, extending base types from `@revealui/schema/core` with RevealUI-specific features.
...
### Base Types (from @revealui/schema/core)
