import type { RichTextAdapter } from '@revealui/cms/core/payload'

import { genImportMapIterateFields } from '@revealui/cms/core/payload'

import type { ResolvedServerFeatureMap } from './features/typesServer'
...
export const getGenerateImportMap =
  ...
  ({ addToImportMap, baseDir, config, importMap, imports }) => {
    addToImportMap('revealui/cms/richtext-lexical/rsc#RscEntryLexicalCell')
    addToImportMap('revealui/cms/richtext-lexical/rsc#RscEntryLexicalField')
    addToImportMap('revealui/cms/richtext-lexical/rsc#LexicalDiffComponent')
