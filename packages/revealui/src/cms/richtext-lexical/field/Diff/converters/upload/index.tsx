import type { FileData, PayloadRequest, TypeWithID } from '@revealui/cms/core/payload'

import { type I18nClient } from '../../translations/index.js'
import { File } from '../../ui/index.js/rsc'
