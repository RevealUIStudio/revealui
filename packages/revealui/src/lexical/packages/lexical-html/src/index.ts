...
import type {
  ...
  LexicalEditor,
  LexicalNode,
} from '../../../lexical/packages/lexical/src/index';

import {$sliceSelectedTextNodeContent} from '../../../lexical/packages/lexical-selection/src/index';
import {isBlockDomNode, isHTMLElement} from '../../../lexical/packages/lexical-utils/src/index';
import {
  $createLineBreakNode,
  $createParagraphNode,
  $getRoot,
