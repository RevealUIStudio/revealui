...
import {$isLinkNode, LinkNode} from '../../../lexical/packages/lexical-link/src/index';
import {$isMarkNode} from '../../../lexical/packages/lexical-mark/src/index';
import {$isTableSelection, TableSelection} from '../../../lexical/packages/lexical-table/src/index';
import {
  $getRoot,
  $getSelection,
  $isElementNode,
