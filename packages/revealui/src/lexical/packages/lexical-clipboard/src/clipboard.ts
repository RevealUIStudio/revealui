...
import {$addNodeStyle, $sliceSelectedTextNodeContent} from '../../../lexical/packages/lexical-selection/src/index';
import {objectKlassEquals} from '../../../lexical/packages/lexical-utils/src/index';
import {
  $caretFromPoint,
  $createTabNode,
  $getCaretRange,
