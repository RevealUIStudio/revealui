...
import {DragonExtension} from '../../../lexical/packages/lexical-dragon/src/index';
import {
  $moveCharacter,
  $shouldOverrideDefaultCharacterSelection,
} from '../../../lexical/packages/lexical-selection/src/index';
import {mergeRegister, objectKlassEquals} from '../../../lexical/packages/lexical-utils/src/index';
import {
  $getSelection,
  $isRangeSelection,
  $selectAll,
