...
import type {CodeHighlightNode} from '../../../lexical/packages/lexical-code/src/index';
import type {
  DOMConversionMap,
  DOMConversionOutput,
  DOMExportOutput,
...
import {addClassNamesToElement, isHTMLElement} from '../../../lexical/packages/lexical-utils/src/index';
import {
  $create,
  $createLineBreakNode,
  $createParagraphNode,
