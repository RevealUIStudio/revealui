...
import {$patchStyleText} from '../../../lexical/packages/lexical-selection/src/index';
import {
  $createParagraphNode,
  $getRoot,
  $getSelection,
  ...
  initializeUnitTest(
    (testEnv) => {
      ...
      const HTML_COPY_PASTING_TESTS = [
        {
          expectedHTML: `<p dir="auto"><span data-lexical-text="true">Hello!</span></p>`,
        ...
        {
          expectedHTML: `<p dir="auto"><span data-lexical-text="true">123</span></p><p dir="auto"><span data-lexical-text="true">456</span></p>`,
          name: 'a single div',
          pastedHTML: `123
            <div>
              456
        ...
        {
          expectedHTML: `<p dir="auto"><span data-lexical-text="true">a b c d e</span></p><p dir="auto"><span data-lexical-text="true">f g h</span></p>`,
        ...
        {
          expectedHTML: `<p dir="auto" style="text-align: start;"><span data-lexical-text="true">checklist</span></p><ul dir="auto"><li role="checkbox" tabindex="-1" aria-checked="true" value="1" style="text-align: start;"><span data-lexical-text="true">done</span></li><li role="checkbox" tabindex="-1" aria-checked="false" value="2" style="text-align: start;"><span data-lexical-text="true">todo</span></li></ul>`,
