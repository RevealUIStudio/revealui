...
import {$insertDataTransferForRichText} from '../../../lexical/packages/lexical-clipboard/src/index';
import {
  $createParagraphNode,
  $getRoot,
  $getSelection,
...
describe('CodeBlock tests', () => {
  initializeUnitTest(
    (testEnv) => {
       ...
       *
       */
      const EXPECTED_HTML = `<code spellcheck="false" dir="auto"><span data-lexical-text="true">function run() {</span><br><span data-lexical-text="true">  return [null, undefined, 2, ""];</span><br><span data-lexical-text="true">}</span></code>`;
      ...
      const CODE_PASTING_TESTS = [
        ...
        {
          expectedHTML: `<code spellcheck="false" dir="auto"><strong class="editor-text-bold" data-lexical-text="true">function</strong><span data-lexical-text="true"> run() {</span><br><span data-lexical-text="true">  </span><strong class="editor-text-bold" data-lexical-text="true">return</strong><span data-lexical-text="true"> [</span><strong class="editor-text-bold" data-lexical-text="true">null</strong><span data-lexical-text="true">, </span><strong class="editor-text-bold" data-lexical-text="true">undefined</strong><span data-lexical-text="true">, 2, ""];</span><br><span data-lexical-text="true">}</span></code>`,
          name: 'Postman IDE',
        ...
        {
          expectedHTML: `<code spellcheck="false" dir="auto"><span data-lexical-text="true">const Lexical = requireCond('gk', 'runtime_is_dev', {</span><br><span data-lexical-text="true">  true: 'Lexical.dev',</span><br><span data-lexical-text="true">  false: 'Lexical.prod',</span><br><span data-lexical-text="true">});</span></code>`,
          name: 'CodeHub',
        ...
        {
          expectedHTML: `<p dir="auto"><code spellcheck="false" data-lexical-text="true"><span>12</span></code></p>`,
