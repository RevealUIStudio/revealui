...
import {$isHeadingNode, HeadingNode, HeadingTagType} from '../../../lexical/packages/lexical-rich-text/src/index';
import {$getNextRightPreorderNode} from '../../../lexical/packages/lexical-utils/src/index';
import {
  $getNodeByKey,
  $getRoot,
  $isElementNode,
