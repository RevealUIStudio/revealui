...
import {$createCodeNode} from '../../../lexical/packages/lexical-code/src/index';
import {
...
import {$createHeadingNode, $createQuoteNode} from '../../../lexical/packages/lexical-rich-text/src/index';
import {$setBlocksType} from '../../../lexical/packages/lexical-selection/src/index';
import {INSERT_TABLE_COMMAND} from '../../../lexical/packages/lexical-table/src/index';
import {
  $createParagraphNode,
  $getSelection,
  $isRangeSelection,
