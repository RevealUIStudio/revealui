...
import {$isDecoratorBlockNode} from '../../../lexical/packages/lexical-react/src/index';
import {
  $createHeadingNode,
  $createQuoteNode,
  $isHeadingNode,
  $isQuoteNode,
  HeadingTagType,
} from '../../../lexical/packages/lexical-rich-text/src/index';
import {$patchStyleText, $setBlocksType} from '../../../lexical/packages/lexical-selection/src/index';
import {$isTableSelection} from '../../../lexical/packages/lexical-table/src/index';
import {$getNearestBlockElementAncestorOrThrow} from '../../../lexical/packages/lexical-utils/src/index';
import {
  $addUpdateTag,
  $createParagraphNode,
  $getSelection,
