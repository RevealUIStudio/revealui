...
import type {CodeNode} from '../../../lexical/packages/lexical-code/src/index';
import type {ThemedToken, TokensResult} from '@shikijs/types';
import type {LexicalEditor, LexicalNode, NodeKey} from 'lexical';

import {$createCodeHighlightNode, $isCodeNode} from '../../../lexical/packages/lexical-code/src/index';
import {
