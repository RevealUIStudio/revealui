...
import type { PopulateType, RevealDataObject, RevealDocument, RevealSelect, RevealSort, RevealWhere, SelectType } from './query.js';
...
export interface RevealUIInstance {
    ...
    secret?: string;
    find: (options: RevealFindOptions & {
        collection: string;
    ...
    create: (options: RevealCreateOptions & {
        collection: string;
    }) => Promise<RevealDocument>;
    update: (options: RevealUpdateOptions & {
        collection: string;
    }) => Promise<RevealDocument>;
    delete: (options: RevealDeleteOptions & {
        collection: string;
    }) => Promise<RevealDocument>;
    login: (options: {
        collection: string;
