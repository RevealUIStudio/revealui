 ...
 */
export declare function cacheQuery<T>(
  key: string,
  queryFn: () => Promise<T>,
 ...
 */
export declare function cacheList<T>(
  resource: string,
 ...
 */
export declare function cacheItem<T>(
  resource: string,
  id: string | number,
  queryFn: () => Promise<T>,
  ttl?: number,
 ...
 */
export declare function cacheCount(
  resource: string,
  filters: Record<string, unknown>,
 ...
 */
export declare function memoize<T extends (...args: unknown[]) => Promise<unknown>>(
  fn: T,
  options?: CacheOptions,
): T
/**
 ...
 */
export declare function withCache<T extends (...args: unknown[]) => Promise<unknown>>(
  queryFn: T,
  options: {
 ...
 */
export declare function batchCache<T>(
  operations: Array<{
    key: string
    queryFn: () => Promise<T>
    ttl?: number
 ...
 */
export declare function cacheSWR<T>(
  key: string,
  queryFn: () => Promise<T>,
  options?: {
    ttl?: number
