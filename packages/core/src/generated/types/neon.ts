...
/* eslint-disable */
/**
 * This file was automatically generated and copied from ./packages/db/src/types/database.ts
 * DO NOT MODIFY IT BY HAND. Instead, regenerate the source file and re-run this script.
 *
 * Last updated: 2026-01-16T04:19:17.196Z
 */
...
import type {
  ...
  media,
  posts,
} from '@revealui/db/schema/cms'
import type { crdtOperations } from '@revealui/db/schema/crdt-operations'
import type { nodeIdMappings } from '@revealui/db/schema/node-ids'
import type { pageRevisions, pages } from '@revealui/db/schema/pages'
import type { failedAttempts, rateLimits } from '@revealui/db/schema/rate-limits'
import type { siteCollaborators, sites } from '@revealui/db/schema/sites'
import type { sessions, users } from '@revealui/db/schema/users'
