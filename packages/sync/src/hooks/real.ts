...
import type { Conversation, ConversationMessage, Memory } from '../collections/conversations.js'
...
export {
  ...
  conversationCollection as default,
  memoryCollection,
} from '../collections/conversations.js'
