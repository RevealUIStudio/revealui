...
// ---------------------------------------------------------------------------
// Brand primitives (People / Content / Offers / Payments / Agents)
// Path data lifted from apps/marketing/app/content/primitives.ts — fixed
// brand marks for the five primitives. Distinct from tintable UI glyphs
// (e.g. IconUsers): different geometry, different job. Gate 5 / ICONS.md.
// ---------------------------------------------------------------------------

export function IconPrimitivePeople(props: IconProps) {
  return (
    <IconBase {...props}>
...
export function IconPrimitiveContent(props: IconProps) {
  return (
    <IconBase {...props}>
...
export function IconPrimitiveOffers(props: IconProps) {
  return (
    <IconBase {...props}>
...
export function IconPrimitivePayments(props: IconProps) {
  return (
    <IconBase {...props}>
...
export function IconPrimitiveAgents(props: IconProps) {
  return (
    <IconBase {...props}>
