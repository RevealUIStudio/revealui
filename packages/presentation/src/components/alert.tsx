          ...
          <div className="grid min-h-full grid-rows-[1fr_auto_1fr] justify-items-center p-8 sm:grid-rows-[1fr_auto_3fr] sm:p-4">
            <div
              ...
              className={cn(
                className,
                sizes[size],
                'row-start-2 w-full rounded-2xl bg-card p-8 shadow-lg ring-1 ring-border-strong sm:rounded-2xl sm:p-6 forced-colors:outline',
...
export function AlertTitle({
  ...
  return (
    <h2
      ...
      className={cn(
        className,
        'text-center text-base/6 font-semibold text-balance text-foreground sm:text-left sm:text-sm/6 sm:text-wrap',
      )}
    />
  );
}
