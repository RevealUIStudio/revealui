 ...
 */
const PRIMITIVES = [
  { name: 'IconPrimitivePeople', primitive: 'People', accent: 'cobalt (declared emerald, aliased)' },
...
const CATEGORY_ORDER = ['Navigation', 'Status', 'Actions', 'Identity', 'Theme', 'Product', 'Uncategorised'];
