...
/**
 * Public GitHub is indexed. Adversarial security-review writeups stay private.
 * The recorded verdict marker may be public. Owner 2026-08-16 after revealui#2640.
 */
export const publicIssueRedactionRule: Rule = {
  id: 'public-issue-redaction',
  tier: 'oss',
  name: 'Public Issue Redaction',
  description:
    'HARDLINE: do not publish attack writeups, unfixed-finding maps, or soft-enforcement notes on public GitHub',
  scope: 'global',
  preambleTier: 1,
  tags: ['security', 'hardline', 'github', 'redaction'],
  content: `# Public Issue Redaction (HARDLINE)
