...
export const mockAccessAuthenticated: AccessFunction = ({ req }) =>
	Boolean(req?.user);
...
export function createMockAfterChangeHook<
	T = unknown,
...
export function createMockFieldHooks<
	TValue = string,
>(): FieldHooksConfig<TValue> {
	return {
