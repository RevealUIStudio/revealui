...
describe("Validation Utilities", () => {
	describe("validateContextKey", () => {
		...
		it("should reject dangerous keys", () => {
			expect(() => validateContextKey("__proto__")).toThrow(
				"Dangerous context key",
			);
			expect(() => validateContextKey("constructor")).toThrow(
				"Dangerous context key",
			);
			expect(() => validateContextKey("prototype")).toThrow(
				"Dangerous context key",
			);
		});
	...
	describe("validateContextValue", () => {
		...
		it("should reject undefined values", () => {
			expect(() => validateContextValue(undefined, "key")).toThrow(
				"cannot be undefined",
			);
		});

		it("should reject functions", () => {
			expect(() => validateContextValue(() => {}, "key")).toThrow(
				"cannot be functions",
			);
		});

		it("should reject symbols", () => {
			expect(() => validateContextValue(Symbol("test"), "key")).toThrow(
				"cannot be symbols",
			);
		});
	});
	...
	describe("validateContext", () => {
		...
		it("should reject contexts with dangerous keys", () => {
			...
			expect(() => validateContext(protoContext)).toThrow(
				"Dangerous context key",
			);
		});
