 ...
 *
 * Generates a centralized Database type from Drizzle schemas.
 * The emitted `public.Tables` key is a leftover Supabase Database<> index
 * (legacy helpers). Neon is the SSOT; there is no product `public` schema.
 *
 * This script:
