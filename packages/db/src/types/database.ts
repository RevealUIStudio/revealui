 ...
 *
 * Generated: 2026-03-11T23:30:48.176Z
 *
...
export const coordinationEventsRelationships = [
  { foreignKeyName: 'coordination_events_session_id_coordination_sessions_id_fk', columns: ['session_id'], isOneToOne: true, referencedRelation: 'coordination_sessions', referencedColumns: ['id'] },
] as const satisfies readonly Relationship[]

// CoordinationFileClaims relationships
export const coordinationFileClaimsRelationships = [
  { foreignKeyName: 'coordination_file_claims_session_id_coordination_sessions_id_fk', columns: ['session_id'], isOneToOne: true, referencedRelation: 'coordination_sessions', referencedColumns: ['id'] },
] as const satisfies readonly Relationship[]
...
export const coordinationSessionsRelationships = [
  { foreignKeyName: 'coordination_sessions_agent_id_coordination_agents_id_fk', columns: ['agent_id'], isOneToOne: true, referencedRelation: 'coordination_agents', referencedColumns: ['id'] },
] as const satisfies readonly Relationship[]

// CoordinationWorkItems relationships
export const coordinationWorkItemsRelationships = [
  { foreignKeyName: 'coordination_work_items_owner_session_coordination_sessions_id_fk', columns: ['owner_session'], isOneToOne: true, referencedRelation: 'coordination_sessions', referencedColumns: ['id'] },
  { foreignKeyName: 'coordination_work_items_parent_id_coordination_work_items_id_fk', columns: ['parent_id'], isOneToOne: true, referencedRelation: 'coordination_work_items', referencedColumns: ['id'] },
] as const satisfies readonly Relationship[]
