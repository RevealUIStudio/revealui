...
export const boardColumnsRelationships = [
  {
    foreignKeyName: 'board_columns_board_id_boards_id_fk',
    columns: ['board_id'],
    isOneToOne: true,
...
export const boardsRelationships = [
  {
    foreignKeyName: 'boards_owner_id_users_id_fk',
    columns: ['owner_id'],
    isOneToOne: true,
    referencedRelation: 'users',
    referencedColumns: ['id'],
...
export const codeProvenanceRelationships = [
  {
    foreignKeyName: 'code_provenance_reviewed_by_users_id_fk',
    columns: ['reviewed_by'],
    isOneToOne: true,
    referencedRelation: 'users',
    referencedColumns: ['id'],
...
export const codeReviewsRelationships = [
  {
    foreignKeyName: 'code_reviews_provenance_id_code_provenance_id_fk',
    columns: ['provenance_id'],
    isOneToOne: true,
    referencedRelation: 'code_provenance',
    referencedColumns: ['id'],
  },
  {
    foreignKeyName: 'code_reviews_reviewer_id_users_id_fk',
    columns: ['reviewer_id'],
    isOneToOne: true,
    referencedRelation: 'users',
    referencedColumns: ['id'],
...
export const collabEditsRelationships = [
  {
    foreignKeyName: 'collab_edits_document_id_yjs_documents_id_fk',
    columns: ['document_id'],
    isOneToOne: true,
    referencedRelation: 'yjs_documents',
    referencedColumns: ['id'],
  },
] as const satisfies readonly Relationship[]
...
export const licensesRelationships = [
  {
    foreignKeyName: 'licenses_user_id_users_id_fk',
    columns: ['user_id'],
    isOneToOne: true,
    referencedRelation: 'users',
    referencedColumns: ['id'],
...
export const ticketCommentsRelationships = [
  ...
  {
    foreignKeyName: 'ticket_comments_author_id_users_id_fk',
    columns: ['author_id'],
    isOneToOne: true,
    referencedRelation: 'users',
    referencedColumns: ['id'],
...
export const ticketLabelAssignmentsRelationships = [
  {
    foreignKeyName: 'ticket_label_assignments_ticket_id_tickets_id_fk',
    columns: ['ticket_id'],
    isOneToOne: true,
    referencedRelation: 'tickets',
    referencedColumns: ['id'],
  ...
  {
    foreignKeyName: 'ticket_label_assignments_label_id_ticket_labels_id_fk',
    columns: ['label_id'],
    isOneToOne: true,
...
export const ticketsRelationships = [
  {
    foreignKeyName: 'tickets_board_id_boards_id_fk',
    columns: ['board_id'],
    isOneToOne: true,
    referencedRelation: 'boards',
    referencedColumns: ['id'],
  ...
  {
    foreignKeyName: 'tickets_column_id_board_columns_id_fk',
    columns: ['column_id'],
    isOneToOne: true,
  ...
  {
    foreignKeyName: 'tickets_assignee_id_users_id_fk',
    columns: ['assignee_id'],
    isOneToOne: true,
    referencedRelation: 'users',
    referencedColumns: ['id'],
  ...
  {
    foreignKeyName: 'tickets_reporter_id_users_id_fk',
    columns: ['reporter_id'],
    isOneToOne: true,
    referencedRelation: 'users',
    referencedColumns: ['id'],
  ...
  {
    foreignKeyName: 'tickets_parent_ticket_id_tickets_id_fk',
