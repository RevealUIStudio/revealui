...
>
export declare const passwordResetTokensRelations: import('drizzle-orm').Relations<
  'password_reset_tokens',
  {
    user: import('drizzle-orm').One<'users', true>
  }
>
export declare const sitesRelations: import('drizzle-orm').Relations<
  'sites',
  {
...
>
export declare const siteCollaboratorsRelations: import('drizzle-orm').Relations<
  'site_collaborators',
  {
...
>
export declare const pagesRelations: import('drizzle-orm').Relations<
  'pages',
  {
    site: import('drizzle-orm').One<'sites', true>
...
>
export declare const pageRevisionsRelations: import('drizzle-orm').Relations<
  'page_revisions',
  {
...
export declare const agentMemoriesRelations: import('drizzle-orm').Relations<
  'agent_memories',
  {
...
>
export declare const conversationsRelations: import('drizzle-orm').Relations<
  'conversations',
  {
    user: import('drizzle-orm').One<'users', true>
...
>
export declare const agentActionsRelations: import('drizzle-orm').Relations<
  'agent_actions',
  {
...
>
export declare const mediaRelations: import('drizzle-orm').Relations<
  'media',
  {
