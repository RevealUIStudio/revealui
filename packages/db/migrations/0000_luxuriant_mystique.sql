...
ALTER TABLE "coordination_sessions" ADD CONSTRAINT "coordination_sessions_agent_id_coordination_agents_id_fk" FOREIGN KEY ("agent_id") REFERENCES "public"."coordination_agents"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
