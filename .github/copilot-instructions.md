...
- Big picture: Next.js 16 + React 19 monorepo. Apps live in `apps/` (notably `apps/cms`, `apps/web`, `apps/api`) and shared code lives in `packages/` (core, `auth`, `services`, `mcp`).
