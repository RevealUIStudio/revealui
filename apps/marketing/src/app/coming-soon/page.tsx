...
export const metadata: Metadata = {
  title: 'Coming Soon — RevealUI',
  description:
    'Features and capabilities currently in development for RevealUI. See what we are building next.',
  openGraph: {
    title: 'Coming Soon — RevealUI',
    description: 'Features and capabilities currently in development for RevealUI.',
    type: 'website',
  },
};
            ...
            {features.map((feature) => (
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <span
                    className={`text-xs font-semibold px-2.5 py-0.5 rounded-full ${categoryColors[feature.category] ?? 'bg-gray-100 text-gray-700'}`}
                  >
                    {feature.category}
                  </span>
