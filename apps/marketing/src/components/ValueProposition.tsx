...
export function ValueProposition() {
  const features = [
    ...
    },
    {
      ...
      description:
        'Define collections in TypeScript, get a REST API, admin dashboard, and MCP tools automatically. Humans manage content through the UI. Agents operate on it through the same API. No integration step.',
    ...
    },
    {
      ...
      description:
        '10 MCP servers, agent coordination, and open-model inference, built into the foundation, not bolted on. Agents discover tools, remember context, and transact autonomously. No proprietary API keys required.',
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-3xl font-bold tracking-tight text-gray-950 sm:text-4xl">
            One foundation for humans and agents
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-500">
            Every software business needs auth, billing, content, and AI. RevealUI ships them
            pre-wired, for you and for the agents that will operate on your business. Built on the
            JOSHUA Stack: six engineering principles that govern every decision.
          </p>
        </div>
