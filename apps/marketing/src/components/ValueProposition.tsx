...
export function ValueProposition() {
  const features = [
    ...
    },
    {
      ...
      description:
        'AI agents, MCP servers, and structured workflows — built into the foundation, not bolted on. Open models, local inference, zero API bills. Your AI runs on your terms.',
