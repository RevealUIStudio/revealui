...
export function ValueProposition() {
  const features = [
    ...
    },
    {
      ...
      description:
        '11 MCP servers, agent coordination, and open-model inference, built into the foundation, not bolted on. Agents discover tools, remember context, and transact autonomously. No proprietary API keys required.',
