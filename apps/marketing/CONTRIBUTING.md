...
| `content/pricing.ts`, `pricing-faq.ts`, `pricing-teaser.ts` | `/pricing` copy (tier data re-exported from `@revealui/contracts/public-catalog`) |
| `content/proof.ts` | homepage proof section |
