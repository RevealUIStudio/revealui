  ...
  },
  {
    ...
    evidence: [
      ...
      },
      {
        ...
        note: 'locks the known-for H1 as the homepage default after Brand LOCK 2026-09-15',
      },
      LICENSE_MIT,
      SELF_HOST,
    ],
  ...
  },
  {
    ...
    evidence: [
      ...
      SELF_HOST,
      {
        kind: 'code',
        ref: 'packages',
        note: 'sanctioned A/B variant of HOME_HERO.h1; known-for #5 keep-the-stack, not receipts-only',
      },
    ],
  },
  {
