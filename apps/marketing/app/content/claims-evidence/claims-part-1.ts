...
export const claimsPart1: readonly ClaimEntry[] = [
  ...
  },
  {
    ...
    proofGrade: 'outcome',
    text: 'Secret vault for the whole fleet',
  ...
  },
  {
    ...
    proofGrade: 'behavior',
    text: 'CLI and desktop app for day-to-day secret work',
    evidence: [REVVAULT_REPO],
  },
  {
    file: 'products.ts',
    ...
    proofGrade: 'behavior',
    text: 'Age-locked store, no plaintext .env as source of truth',
    evidence: [REVVAULT_REPO],
  },
  {
    file: 'products.ts',
    ...
    proofGrade: 'behavior',
    text: 'One vault the rest of the fleet is built to read',
    evidence: [REVVAULT_REPO],
  },
  {
    file: 'products.ts',
    exportPath: 'PRODUCTS_SISTERS[1].tagline',
    proofGrade: 'outcome',
    text: 'Studio-run operator preview, not a self-serve stamp',
  ...
  },
  {
    ...
    proofGrade: 'behavior',
    text: 'Operator preview the studio runs with you',
    evidence: [REVFORGE_REF],
  },
  {
    file: 'products.ts',
    ...
    proofGrade: 'behavior',
    text: 'Not an unattended RevForge or Fleet pull-and-run kit',
    evidence: [REVFORGE_REF],
  },
  {
    file: 'products.ts',
  ...
  {
    file: 'products.ts',
    exportPath: 'PRODUCTS_SISTERS[2].tagline',
    proofGrade: 'outcome',
    text: 'Multi-agent engineering harness',
  ...
  },
  {
    ...
    proofGrade: 'behavior',
    text: 'Desktop Studio, Console, and local daemon',
    evidence: [REVDEV_REPO],
  },
  {
    file: 'products.ts',
  ...
  },
  {
    ...
    proofGrade: 'behavior',
    text: 'One place to run and watch agent work on your code',
    evidence: [REVDEV_REPO],
  },
  {
    file: 'products.ts',
    exportPath: 'PRODUCTS_SISTERS[3].tagline',
    proofGrade: 'outcome',
    text: 'Editor config sync across projects',
    evidence: [REVCON_REPO],
  },
  {
    file: 'products.ts',
    exportPath: 'PRODUCTS_SISTERS[3].highlights[0]',
    proofGrade: 'behavior',
    text: 'Zed and Cursor configs in one place',
    evidence: [REVCON_REPO],
  },
  {
    file: 'products.ts',
    ...
    proofGrade: 'behavior',
    text: 'Linked into each project you work on',
    evidence: [REVCON_REPO],
  },
  {
    file: 'products.ts',
    ...
    proofGrade: 'behavior',
    text: 'Edit once, keep the fleet consistent',
    evidence: [REVCON_REPO],
  },
  {
    file: 'products.ts',
    ...
    proofGrade: 'outcome',
    text: 'Agent skills library for real engineering work',
  ...
  },
  {
    ...
    proofGrade: 'behavior',
    text: 'Database, test, and security patterns ready to use',
    evidence: [REVSKILLS_REPO],
  },
  {
    file: 'products.ts',
    ...
    proofGrade: 'behavior',
    text: 'Drop into your agent harness and go',
    evidence: [REVSKILLS_REPO],
  },
  {
    file: 'products.ts',
    exportPath: 'PRODUCTS_SISTERS[4].highlights[2]',
    proofGrade: 'behavior',
    text: 'Free, open, and importable',
    evidence: [REVSKILLS_REPO],
  },
  {
    file: 'products.ts',
    ...
    proofGrade: 'behavior',
    text: 'N first-party integrations ship with the runtime. (interpolated: N from METRICS.mcpServers)',
    match: 'path',
  ...
  },
  {
    ...
    proofGrade: 'behavior',
    text: 'Third-party publishing is planned, not shipped',
    evidence: [ROADMAP],
  },
  {
    file: 'products.ts',
    exportPath: 'PRODUCTS_SISTERS_SECTION.description',
    proofGrade: 'outcome',
    text: 'Sister products that extend the runtime: secrets, operator tools, skills, and the agent tool catalog.',
    evidence: [REVVAULT_REPO, REVDEV_REPO, REVCON_REPO, REVSKILLS_REPO, REVFORGE_REF, ROADMAP],
  },
  {
    file: 'products.ts',
