import {
  A2A_ROUTES,
  ADMIN_LICENSE_PAGE,
  AGENCY_PERPETUAL_JWT_TEST,
  AGENCY_PERPETUAL_MAX_SITES,
  AGENCY_PERPETUAL_MINT_TEST,
...
export const claimsPart2: readonly ClaimEntry[] = [
  ...
  },
  {
    ...
    text: 'One year of priority support included, then optional annual support renewal',
    evidence: [PERPETUAL],
  },
  {
    file: 'pricing.ts',
    exportPath: 'PRICING_AGENCY_FOUNDING_KIT.points[2]',
    text: 'Checkout in the admin license page after you sign in (Stripe one-time payment)',
    evidence: [ADMIN_LICENSE_PAGE, PERPETUAL],
  },
  {
    file: 'pricing.ts',
  ...
  },
  {
    ...
    text: 'Buy Agency Perpetual in admin',
    evidence: [ADMIN_LICENSE_PAGE, PERPETUAL],
  },
  {
    file: 'pricing.ts',
    exportPath: 'PRICING_AGENCY_FOUNDING_KIT.secondaryCta.label',
    text: 'Compare perpetual tiers on this page',
    evidence: [PERPETUAL],
  },
  {
    file: 'pricing.ts',
  ...
  },
  {
    ...
    evidence: [AGENCY_PERPETUAL_MAX_SITES, ADMIN_LICENSE_PAGE],
  },
  {
    file: 'pricing-faq.ts',
