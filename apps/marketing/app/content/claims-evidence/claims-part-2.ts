...
export const claimsPart2: readonly ClaimEntry[] = [
  ...
  },
  {
    ...
    evidence: [AGENCY_PERPETUAL_MAX_SITES, PERPETUAL, PERPETUAL_NEVER_EXPIRES_TEST],
  },
  {
    file: 'pricing.ts',
  ...
  },
  {
    ...
    evidence: [ADMIN_LICENSE_PAGE, BILLING],
  },
  {
    file: 'pricing.ts',
