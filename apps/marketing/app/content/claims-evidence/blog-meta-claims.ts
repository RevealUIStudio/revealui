...
export const blogMetaClaims: readonly ClaimEntry[] = [
  ...
  },
  {
    ...
    exportPath: 'title',
    text: '68 Components, One Dependency',
    evidence: [
  ...
  },
  {
    file: 'blog/component-library',
    exportPath: 'excerpt',
    text: 'A native React component library with 68 components and a single runtime dependency. No Radix, no MUI, no lock-in, just components you own.',
    evidence: [
      { kind: 'code', ref: 'docs/blog/09-component-library.md', note: 'static post body source' },
      {
        kind: 'code',
