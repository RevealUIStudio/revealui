...
export const claimsPart4: readonly ClaimEntry[] = [
  ...
  {
    file: 'philosophy.ts',
    exportPath: 'PHILOSOPHY.h1',
    text: 'Self-host one runtime. Reuse it on the next product.',
    evidence: [SELF_HOST, ENGINES],
  },
  {
    file: 'philosophy.ts',
    exportPath: 'PHILOSOPHY.sections[0].body',
    text: 'RevealUI packages people, content, offers, payments, and agents as software you self-host. A deployment that works stays yours to run again.',
    evidence: [SELF_HOST, ENGINES],
  },
  {
    file: 'philosophy.ts',
    exportPath: 'PHILOSOPHY.sections[1].body',
    text: 'Most stacks scatter after ship. The next product starts from zero: new auth, new admin, new billing glue.',
    evidence: [BIO],
  },
  {
    file: 'philosophy.ts',
    exportPath: 'PHILOSOPHY.sections[2].body',
    text: 'Five primitives are a contract you implement once. An agent that works in your business keeps its memory in a store you own.',
    evidence: [ENGINES, MEMORY],
  },
  {
    file: 'philosophy.ts',
    exportPath: 'PHILOSOPHY.sections[3].body',
    text: 'You still pay for your own Postgres and compute. The source is in the public repo.',
  ...
  },
  {
    ...
    text: 'A registry where developers publish and discover MCP servers and AI agent capabilities. First-party MCP servers ship today. Third-party publishing and live marketplace charging are not open yet.',
    evidence: [ROADMAP],
  },
  {
    file: 'roadmap.ts',
    exportPath: 'ROADMAP_UPCOMING[1].name',
    text: 'RevealUI Fleet pull-and-run kit',
    evidence: [DOCKER_GHCR_WORKFLOW, ROADMAP],
  },
  {
    file: 'roadmap.ts',
    exportPath: 'ROADMAP_UPCOMING[1].description',
    text: 'CI already builds and pushes api, admin, and migrate images to GitHub Container Registry. The launched product is a documented, license-gated pull-and-run kit that a customer can deploy without building from source.',
    evidence: [DOCKER_GHCR_WORKFLOW, ROADMAP],
  },
  {
    file: 'roadmap.ts',
