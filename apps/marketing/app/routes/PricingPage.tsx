...
export function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* GAP-448 Agency Founding Kit — Agency Perpetual productized */}
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl rounded-2xl bg-card p-8 shadow-lg ring-1 ring-border sm:p-10">
            <div className="flex flex-wrap items-center gap-3">
              ...
              {PRICING_AGENCY_FOUNDING_KIT.badge ? (
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <Button
                ...
                className="w-full sm:w-auto"
              >
                <a href={PRICING_AGENCY_FOUNDING_KIT.monthlyEscape.href}>
                  {PRICING_AGENCY_FOUNDING_KIT.monthlyEscape.label}
                </a>
              </Button>
            </div>
          </div>
