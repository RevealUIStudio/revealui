 ...
 * the bare canonical URL (`/`) serves the developer-facing runtime pitch.
 * `/?for=non-technical` still serves the operator corpus (the same content now
 * also lives at its own URL, `/services`). audienceHref()'s canonical-URL
