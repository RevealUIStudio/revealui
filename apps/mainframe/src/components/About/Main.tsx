    ...
    >
      ...
      <FlexContainer className="mx-auto mb-20 mt-10 w-full flex-col" index={2}>
        ...
        <Container className="isolate mx-auto rounded-3xl bg-transparent shadow-2xl ">
          <GridContainer className="mx-auto aspect-auto grid-cols-1 lg:grid-cols-3" index={1}>
            <Image
      ...
      >
        ...
        <Field className="from-scrapRed to-scrapRed/60 w-full rounded-2xl bg-gradient-to-bl p-5 lg:p-8">
          ...
          <Paragraph className="prose-p text-scrapWhite mt-1 max-w-xl text-sm brightness-150 ">
            We have support groups to join as well for anyone in need of a supportive conversation.
          </Paragraph>

          <Paragraph className="prose-p text-scrapYellow text-md mt-2 font-semibold brightness-150">
            We care about the overall health of all participants and the World at large.
          </Paragraph>
        </Field>
      </GridContainer>
      <FlexContainer className="mx-auto flex flex-col gap-5 lg:flex-row-reverse" index={3}>
        <Image
      ...
      >
        ...
        <Paragraph className=" prose-p text-scrapGreen lg:text-md max-w-sm text-start text-base lg:max-w-3xl lg:text-center">
          We aim to help others tame the fire that burns within, and turn it into something
          constructive to themselves and those around them.
        </Paragraph>
      </FlexContainer>
