				...
				<div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
					<div className="lg:col-span-2">
						...
						<p className="text-gray-400 mb-4">
							The white-label CMS platform built for digital agencies. Deploy
							professional, scalable solutions with full source code access.
						</p>
