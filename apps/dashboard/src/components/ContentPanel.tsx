              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    defaultValue={
                      selectedContent === 'home' ? 'Welcome to Our Agency' :
                      selectedContent === 'about' ? 'About Our Agency' :
                      selectedContent === 'blog' ? 'Latest Blog Posts' :
                      'Contact Us'
                    }
                ...
                <div>
                  ...
                  <textarea
                    rows={8}
                    defaultValue={
                      selectedContent === 'home' ? 'This is the homepage content. Use the AI agent to help optimize this copy.' :
                      selectedContent === 'about' ? 'Learn about our agency and our mission.' :
                      selectedContent === 'blog' ? 'Read our latest thoughts and insights.' :
