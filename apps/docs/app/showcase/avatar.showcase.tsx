...
const story: ShowcaseStory = {
  ...
  examples: [
      ...
      render: () => (
        <div className="flex items-end gap-4">
          {['size-6', 'size-8', 'size-10', 'size-12', 'size-16'].map((size) => (
            <Avatar key={size} initials="AL" alt="Alice" className={size} />
          ))}
        </div>
      ),
    },
    ...
    },
    {
      ...
      render: () => (
        <div className="flex items-end gap-4">
          <Avatar initials="AL" square alt="Square small" className="size-8" />
          <Avatar initials="AL" square alt="Square medium" className="size-12" />
          <Avatar initials="AL" square alt="Square large" className="size-16" />
        </div>
      ),
    },
  ],
