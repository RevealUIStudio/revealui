...
export function Builder() {
	...
	return (
		<div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
			...
			{/* Properties Panel */}
			{selectedComponent && selectedComp ? <div className="lg:col-span-1 bg-white rounded-lg shadow-lg p-6">
					...
					<div className="space-y-4">
						...
						{(selectedComp.type === 'text' || selectedComp.type === 'button') ? <div>
								<label className="block text-sm font-medium text-gray-700 mb-1">
									Content
								</label>
								<textarea
			...
			{/* Canvas */}
			<div className={`${selectedComponent ? 'lg:col-span-3' : 'lg:col-span-4'} bg-white rounded-lg shadow-lg p-6`}>
				...
				{showAI ? <div className="mb-4 border border-purple-200 rounded-lg p-4 bg-purple-50">
						<h3 className="text-sm font-semibold text-purple-800 mb-2">RevealUI AI Assistant</h3>
						<p className="text-sm text-purple-700 mb-2">🤖 AI features coming soon! Configure your API key to enable intelligent assistance.</p>
