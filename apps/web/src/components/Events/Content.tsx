...
const brainwaveServices = ['Photo generating', 'Photo enhance', 'Seamless Integration']
const Gradient = () => {
  return (
...
const Roadmap = () => (
  ...
  >
    <div className="container md:pb-10">
      <Heading tag="Ready to get started" title="What we're working on" className={''} text={''} />
