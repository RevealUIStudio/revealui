import { Field, Container } from "reveal/ui/shells";
import { Heading } from "reveal/ui/text";
import { SongItem } from "reveal/ui/controls";
...
const MusicContent = ({
  ...
  if (!music || music.length === 0) {
    return (
      <Field className="pt-4 text-center text-neutral-400">
        No music available.
      </Field>
    );
  }
