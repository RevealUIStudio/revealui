...
import cronAdmissionPaidPendingExpireRoute from './routes/cron/admission-paid-pending-expire.js';
import cronAdmissionWaitlistDrainRoute from './routes/cron/admission-waitlist-drain.js';
...
app.route('/api/cron', cronRevmarketPayoutsRoute);
...
app.route('/api/v1/cron', cronRevmarketPayoutsRoute);
...
app.route('/api/v1/cron', cronAdmissionWaitlistDrainRoute);
app.route('/api/v1/cron', cronAdmissionPaidPendingExpireRoute);
