...
- **Billing** — Stripe checkout, subscription management, tier upgrades, webhooks
- **License System** — JWT license key generation and validation
...
- **AI**: `@revealui/ai` (agent dispatch, A2A protocol)
- **Payments**: Stripe SDK
...
| Method | Path | Purpose |
|--------|------|---------|
| GET | `/license/validate` | Validate license key |
